 ...
 */ (function(
  ...
  function N(t, o, n) {
    ...
    return (
      i.forEach(function(t) {
        ...
        t.enabled &&
          e(n) &&
          ((o.offsets.popper = c(o.offsets.popper)), (o.offsets.reference = c(o.offsets.reference)), (o = n(o, t)));
      }),
      o
    );
  }
  ...
  function R() {
    this.state.eventsEnabled &&
      (cancelAnimationFrame(this.scheduleUpdate), (this.state = F(this.reference, this.state)));
  }
  function U(e) {
              ...
              s = {
                ...
                secondary: function(e) {
                  var o = 'right' === e ? 'left' : 'top',
                    i = p[o];
                  return (
                    p[e] > n[e] && !t.escapeWithReference && (i = X(p[o], n[e] - ('right' === e ? p.width : p.height))),
                    se({}, o, i)
                  );
                }
              };
        ...
        arrow: {
          ...
          fn: function(e, o) {
            ...
            return (
              (v = Q(X(s[l] - u, v), 0)),
              (e.arrowElement = i),
              (e.offsets.arrow = ((n = {}), se(n, m, Math.round(v)), se(n, h, ''), n)),
              e
            );
          },
          element: '[x-arrow]'
