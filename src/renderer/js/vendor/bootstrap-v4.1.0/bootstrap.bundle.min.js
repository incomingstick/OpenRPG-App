    ...
    function $t(t, n, e) {
        return (
            (void 0 === e
                ...
                t.enabled &&
                    It(e) &&
                    ((n.offsets.popper = Bt(n.offsets.popper)),
                        ...
                        var n = i.priority,
                            ...
                            s = {
                                primary: function(t) {
                                    var e = o[t];
                                    return (
                                        o[t] < r[t] && !i.escapeWithReference && (e = Math.max(o[t], r[t])),
                                        Ft({}, t, e)
                                    );
                                },
                ...
                applyStyle: {
                    ...
                    onLoad: function(t, e, n, i, r) {
                        ...
                        return (
                            ...
                            se(e, { position: n.positionFixed ? 'fixed' : 'absolute' }),
                            n
                        );
                    },
                ...
                return (
                    ...
                    (l._jQueryInterface = function(e) {
                        return this.each(function() {
                            ...
                            if (
                                (t || ((t = new l(this, 'object' == typeof e ? e : null)), ge(this).data(_e, t)),
                                'string' == typeof e)
                            ) {
                        ...
                        if (
                            (/input|textarea/i.test(t.target.tagName)
                                ? !(
                                      32 === t.which ||
                                      (27 !== t.which &&
                                          ((40 !== t.which && 38 !== t.which) || ge(t.target).closest(Le).length))
                                  )
                                : be.test(t.which)) &&
            ...
            (An = (function() {
                ...
                return (
                    ...
                    (t._getConfig = function(t) {
                        return (
                            'number' ==
                                typeof (t = c({}, this.constructor.Default, sn(this.element).data(), t)).delay &&
                ...
                return (
                    ...
                    (n._jQueryInterface = function(e) {
                        return this.each(function() {
                            ...
                            if (
                                (t || ((t = new n(this, 'object' == typeof e && e)), Kn(this).data(Qn, t)),
                                'string' == typeof e)
                            ) {
                                if ('undefined' == typeof t[e]) throw new TypeError('No method named "' + e + '"');
                                t[e]();
