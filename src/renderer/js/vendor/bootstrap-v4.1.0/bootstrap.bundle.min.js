...
!(function(t, e) {
      ...
      vt =
        ...
        (Z = (function() {
          ...
          return (
            ...
            (t.pause = function(t) {
              t || (this._isPaused = !0),
                k(this._element).find(J.NEXT_PREV)[0] && (gt.triggerTransitionEnd(this._element), this.cycle(!0)),
            ...
            (t._slide = function(t, e) {
              ...
              if ((t === W ? ((n = q), (i = z), (r = U)) : ((n = G), (i = X), (r = B)), l && k(l).hasClass(Q)))
                this._isSliding = !1;
  ...
  var Ot = {},
    Nt = function() {
      ...
      return (
        (Ot.all =
          Ot.all ||
          Object.keys(Ot).some(function(t) {
            return Ot[t];
          })),
        Ot[t]
      );
  ...
  function kt(t) {
    ...
    return i && 'BODY' !== i && 'HTML' !== i
      ? -1 !== ['TD', 'TABLE'].indexOf(n.nodeName) && 'static' === Dt(n, 'position')
        ? kt(n)
        : n
      : t
  ...
  function Yt(t, e, n, i) {
    ...
    if ('viewport' === i)
      ...
      var a = void 0;
      'scrollParent' === i
        ? 'BODY' === (a = St(At(e))).nodeName && (a = t.ownerDocument.documentElement)
  ...
  function $t(t, n, e) {
    return (
      (void 0 === e
        ...
        t.enabled &&
          It(e) &&
          ((n.offsets.popper = Bt(n.offsets.popper)), (n.offsets.reference = Bt(n.offsets.reference)), (n = e(n, t)));
      }),
      n
    );
  }
      ...
      modifiers: {
                ...
                secondary: function(t) {
                  ...
                  return (
                    o[t] > r[t] &&
                      ...
                      (n = Math.min(o[e], r[t] - ('right' === t ? o.width : o.height))),
                    Ft({}, e, n)
                  );
                }
              };
        ...
        arrow: {
          ...
          fn: function(t, e) {
            ...
            return (
              ...
              (t.arrowElement = i),
              (t.offsets.arrow = (Ft((n = {}), h, Math.round(E)), Ft(n, u, ''), n)),
              t
            );
          },
          element: '[x-arrow]'
              ...
              y.forEach(function(t, e) {
                ...
                (s || h || d) &&
                  ...
                  (p.offsets.popper = Ut(
                    {},
                    p.offsets.popper,
                    Jt(p.instance.popper, p.offsets.reference, p.placement)
                  )),
        ...
        computeStyle: {
          ...
          fn: function(t, e) {
            ...
            if (
              ...
              (l[u] = 'translate3d(' + d + 'px, ' + p + 'px, 0)'), (l[f] = 0), (l[h] = 0), (l.willChange = 'transform');
            else {
              var g = 'bottom' === f ? -1 : 1,
                m = 'right' === h ? -1 : 1;
            ...
            return (
              (t.attributes = Ut({}, _, t.attributes)),
        ...
        applyStyle: {
          ...
          onLoad: function(t, e, n, i, r) {
            ...
            return e.setAttribute('x-placement', s), se(e, { position: n.positionFixed ? 'fixed' : 'absolute' }), n;
          },
      ...
      function o(t, e) {
        ...
        Ht(this, o),
          ...
          (this.modifiers = Object.keys(this.options.modifiers)
            .map(function(t) {
              return Ut({ name: t }, n.options.modifiers[t]);
            })
            .sort(function(t, e) {
        ...
        Wt(o, [
          ...
          },
          {
            ...
            value: function() {
              return function() {
                this.state.eventsEnabled ||
                  (this.state = ie(this.reference, this.options, this.state, this.scheduleUpdate));
              }.call(this);
            }
          },
          {
  ...
  var ge,
    ...
    bi =
      ...
      (Ke = (function() {
        ...
        return (
            ...
            if (!this._element.disabled && !ge(this._element).hasClass(Ce)) {
              ...
              if ((l._clearMenus(), !e)) {
                ...
                if ((ge(t).trigger(i), !i.isDefaultPrevented())) {
                  ...
                  'ontouchstart' in document.documentElement &&
                    0 === ge(t).closest(Pe).length &&
                    ge(document.body)
                      .children()
                      .on('mouseover', null, ge.noop),
                    this._element.focus(),
                    this._element.setAttribute('aria-expanded', !0),
                    ge(this._menu).toggleClass(we),
                    ge(t)
                      .toggleClass(we)
                      .trigger(ge.Event(Te.SHOWN, n));
                }
              }
            }
          }),
          ...
          (t._getConfig = function(t) {
            return (
              (t = c({}, this.constructor.Default, ge(this._element).data(), t)),
          ...
          (t._getPlacement = function() {
            ...
            return (
              t.hasClass(Ie)
                ? ((e = je), ge(this._menu).hasClass(Se) && (e = Re))
                : t.hasClass(De)
                ? (e = We)
                : t.hasClass(Ae)
                ? (e = Fe)
                : ge(this._menu).hasClass(Se) && (e = He),
              e
            );
          }),
          ...
          (l._jQueryInterface = function(e) {
            return this.each(function() {
              ...
              if (
                (t || ((t = new l(this, 'object' == typeof e ? e : null)), ge(this).data(_e, t)), 'string' == typeof e)
              ) {
                    ...
                    ge(i).trigger(a),
                      a.isDefaultPrevented() ||
                        ('ontouchstart' in document.documentElement &&
                          ge(document.body)
                            .children()
                            .off('mouseover', null, ge.noop),
                        e[n].setAttribute('aria-expanded', 'false'),
                        ge(s).removeClass(we),
                        ge(i)
                          .removeClass(we)
                          .trigger(ge.Event(Te.HIDDEN, o)));
                  }
                }
              }
          }),
          ...
          (l._dataApiKeydownHandler = function(t) {
            if (
              (/input|textarea/i.test(t.target.tagName)
                ? !(
                    32 === t.which ||
                    (27 !== t.which && ((40 !== t.which && 38 !== t.which) || ge(t.target).closest(Le).length))
                  )
                : be.test(t.which)) &&
              (t.preventDefault(), t.stopPropagation(), !this.disabled && !ge(this).hasClass(Ce))
            ) {
      ...
      ge(document)
        .on(Te.KEYDOWN_DATA_API, Ne, Ke._dataApiKeydownHandler)
        .on(Te.KEYDOWN_DATA_API, Le, Ke._dataApiKeydownHandler)
        .on(Te.CLICK_DATA_API + ' ' + Te.KEYUP_DATA_API, Ke._clearMenus)
        .on(Te.CLICK_DATA_API, Ne, function(t) {
        ...
        return (
          ...
          (t.show = function(t) {
            ...
            if (!this._isTransitioning && !this._isShown) {
              ...
              var n = Ve.Event(Je.SHOW, { relatedTarget: t });
          ...
          (t._showElement = function(t) {
            ...
            var i = Ve.Event(Je.SHOWN, { relatedTarget: t }),
              r = function() {
          ...
          (t._enforceFocus = function() {
            ...
            Ve(document)
              .off(Je.FOCUSIN)
              .on(Je.FOCUSIN, function(t) {
                document !== t.target &&
                  e._element !== t.target &&
                  0 === Ve(e._element).has(t.target).length &&
                  e._element.focus();
              });
          }),
          (t._setEscapeEvent = function() {
            ...
            this._isShown && this._config.keyboard
              ? Ve(this._element).on(Je.KEYDOWN_DISMISS, function(t) {
          ...
          (t._setResizeEvent = function() {
            var e = this;
            this._isShown
              ? Ve(window).on(Je.RESIZE, function(t) {
        ...
        return (
          ...
          (t._enter = function(t, e) {
            ...
            (e = e || sn(t.currentTarget).data(n)) ||
              ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), sn(t.currentTarget).data(n, e)),
              t && (e._activeTrigger['focusin' === t.type ? wn : Cn] = !0),
              sn(e.getTipElement()).hasClass(yn) || e._hoverState === mn
                ? (e._hoverState = mn)
          ...
          (t._getConfig = function(t) {
            return (
              'number' == typeof (t = c({}, this.constructor.Default, sn(this.element).data(), t)).delay &&
          ...
          (i._jQueryInterface = function(n) {
            return this.each(function() {
              ...
              if (
                ...
                (t || ((t = new i(this, e)), sn(this).data(ln, t)), 'string' == typeof n)
              ) {
                if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
                t[n]();
              }
    ...
    wi =
      ...
      (Rn = c({}, Ci.DefaultType, { content: '(string|element|function)' })),
      (Mn = 'fade'),
      (Wn = '.popover-header'),
      (Fn = '.popover-body'),
      (Un = {
          ...
          (i._jQueryInterface = function(n) {
            return this.each(function() {
              ...
              if (
                ...
                (t || ((t = new i(this, e)), Sn(this).data(Nn, t)), 'string' == typeof n)
              ) {
                if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
                t[n]();
              }
    ...
    Ii =
      ...
      (zn = { offset: 'number', method: 'string', target: '(string|element)' }),
      (Xn = {
        ...
        return (
          (t.refresh = function() {
            ...
            (this._offsets = []),
              ...
              Kn.makeArray(Kn(this._selector))
                .map(function(t) {
                  var e,
                    n = gt.getSelectorFromElement(t);
                  if ((n && (e = Kn(n)[0]), e)) {
            ...
            if (
              !(
                (this._element.parentNode &&
                  ...
                  ii(this._element).hasClass(ci)) ||
                ii(this._element).hasClass(fi)
              )
            ) {
              var t,
                i,
              ...
              var s = ii.Event(ai.HIDE, { relatedTarget: this._element }),
                a = ii.Event(ai.SHOW, { relatedTarget: i });
              if (
                (i && ii(i).trigger(s),
                ...
                var l = function() {
                  var t = ii.Event(ai.HIDDEN, { relatedTarget: n._element }),
